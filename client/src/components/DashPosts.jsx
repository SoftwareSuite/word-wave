    ...
    scrollbar-thumb-slate-300 dark:scrollbar-track-slate-700 dark:scrollbar-thumb-slate-500'>
      {
        currentUser.isAdmin && userPosts.length > 0 ? (
                ...
                <Table.Body className='divide-y'>
                  <Table.Row className='bg-white dark:border-gray-700 dark:bg-gray-800'>
                    ...
                    <Table.Cell>
                      ...
                      className='text-red-500 cursor-pointer font-medium hover:underline'>Delete</span>
                    </Table.Cell>
          ...
          <p>you have no post available</p>
        )
      }
      <Modal 
            show={showModal} 
            ...
            >
              ...
              <Modal.Body>
                ...
                <h3 className="text-lg mb-5 text-gray-600 dark:text-gray-400">Are you sure that you want to delete this post?</h3>
